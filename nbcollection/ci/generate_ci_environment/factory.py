...
def run_generate_ci_environment(options: argparse.Namespace) -> None:
    ...
    #gen_ci_env(jobs, options.ci_environment, options.project_path, options.enable_website_publication, options.enable_nightly, options.enable_val)
    gen_ci_env(jobs, options.ci_environment, options.project_path, options.enable_website_publication, options.enable_nightly)
